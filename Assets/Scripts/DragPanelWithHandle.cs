...
public class DragPanelWithHandle : MonoBehaviour, IBeginDragHandler, IDragHandler
{
    [SerializeField] RectTransform window;      // The frame to move
    Canvas canvas;
    Vector2 dragOffset; // windowPos - pointerLocal
    ...
    public void OnBeginDrag(PointerEventData e)
    {
        ...
        RectTransformUtility.ScreenPointToLocalPointInRectangle(
            parent, e.position, canvas.renderMode == RenderMode.ScreenSpaceOverlay ? null : e.pressEventCamera,
